...
$(".btnQuestion").click(function () {
	$.post('https://qb-sna-driveschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('https://qb-sna-driveschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('https://qb-sna-driveschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
